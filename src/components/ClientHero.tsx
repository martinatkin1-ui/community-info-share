...
export default function ClientHero() {
  ...
  useEffect(() => {
    ...
    fetch("/api/hero-image?query=Birmingham%20UK%20architecture", {
  ...
  return (
    <section
      ...
      style={{
        backgroundImage: `linear-gradient(120deg, rgba(16,21,36,0.52), rgba(16,21,36,0.38)), url(${backgroundImage ?? "https://source.unsplash.com/2400x1350/?birmingham,uk,canal,architecture"})`,
